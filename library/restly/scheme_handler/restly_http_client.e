...
feature {NONE} -- Initialization
	...
	make (a_base_url: RESTLY_HTTP_URI)
			-- Initialize with base URL `a_base_url`.
		do
			make_from_template (a_base_url.template)
			initialize_session
			base_url := Current
		end
...
feature -- Navigation
	...
	subpath alias "/" (a_segment: STRING): RESTLY_HTTP_CLIENT
		...
		do
			create Result.make (create {RESTLY_HTTP_URI}.make (template.to_string_8 + "/" + a_segment))
		end
